...
## État : v0.2 en cours (machine virtuelle, conditions, formules, boucles, forme canonique)
...
Sous Windows sans `make` :
    ...
    gcc -std=c99 -O2 -o grym.exe src/grym.c src/compilateur.c src/vm.c src/bytecode.c src/decimal.c src/analyseur.c src/arbre.c src/texte.c src/imprimeur.c src/lexeur.c
    ...
    gcc -std=c99 -O2 -o grym-arbre.exe src/grym-arbre.c src/analyseur.c src/arbre.c src/texte.c src/imprimeur.c src/decimal.c src/lexeur.c
    gcc -std=c99 -O2 -o grym-suites.exe src/grym-suites.c src/analyseur.c src/arbre.c src/texte.c src/imprimeur.c src/decimal.c src/lexeur.c
    gcc -std=c99 -O2 -Isrc -o test_analyseur.exe tests/test_analyseur.c src/analyseur.c src/arbre.c src/texte.c src/imprimeur.c src/decimal.c src/lexeur.c
