...
/* Valeurs d'un champ texte des objets conservés d'une entité (hors corbeille), dans l'ordre du dictionnaire,
 * au plus max : les suggestions d'un lien (docs/v2.md, § 10). table : l'entité qui porte le champ (elle-même
