...
Version 1.22, révisée le 23 septembre 2026.
...
| v1.0 | Application console complète : questions à l'utilisateur (grammaire, § 17), mise en forme de l'affichage (§ 4), reprise après erreur (§ 18), formulaire déduit de l'entité (§ 19) ; reste à écrire une vraie application pour éprouver l'ensemble | en cours |
